...
const storage = new CloudinaryStorage({
  ...
  params: { folder: 'gimnasio-perfiles', allowed_formats: ['jpg', 'png', 'jpeg'] },
});
...
router.post('/forgot-password', async (req, res) => {
  try {
    ...
    await user.save();
    const resetUrl = `${process.env.FRONTEND_URL || 'https://gimnasio-app-final.vercel.app'}/reset-password/${resetToken}`;
